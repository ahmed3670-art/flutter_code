...
class GetnowplayingMoviesUsecase extends BaseUsecases<List<Movie>, Noparametr> {
  BaseMoiveRepository baseMoiveRepository;
  GetnowplayingMoviesUsecase(this.baseMoiveRepository);
  @override
  Future<Either<failure, List<Movie>>> call(Noparametr noparametr) async {
    return await baseMoiveRepository.GetNowPlayingMovies();
  }
}
